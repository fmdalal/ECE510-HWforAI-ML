...
This function computes exponent of each element, sum of the the exponent values and divided each each element by the sum
Thus, 2 FLOPs are needed - 1 for exponent and 1 for division. Summation is considered minor in comparision and hence dropped. Hence, the softmax score is multiplied by 2.
...
TOTAL FLOPs = Stage1     + Stage2          + Stage3     + Stage4          + Stage5
            = 49,152,000 + 256,000,000,000 + 32,000,000 + 256,000,000,000 + 16,384,000
            = 512,097,536,000
-----------------------------------------------------------------------------------------------------
To calculate memory transfer across the 5 stages
...
TOTAL MEMORY = Stage1    + Stage2     + Stage3      + Stage4     + Stage5
             = 3,121,152 + 65,024,000 + 128,000,000 + 65,024,000 + 1,040,384
             = 262,209,536

-----------------------------------------------------------------------------------------------------

Airthmetic Intensity = TOTAL FLOPs / TOTAL MEMORY
